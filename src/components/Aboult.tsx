...
//         description: 'Possuímos o serviço de conta corrente para você fazer movimentações com seu dinheiro de forma segura, rápida e sem dores de cabeça.',
//         image: '/images/pc.png',
//         carrency: 'Sem carência',
//     },
//     {
//         id: 2,
//         title: 'Rede Parcerias',
//         description: 'O nosso clube de vantagens é uma plataforma de fácil navegação construída para comunicar, de forma efetiva, os benefícios, descontos e convênios que as empresas parceiras oferecem aos nossos clientes.',
...
//         description: 'Descrição detalhada para Morte Acidental.',
//         image: '/images/def.png',
//         carrency: 'Sem carência',
//     },
//     {
//         id: 4,
//         title: 'Invalidez Permanente e Total por Acidente - IPTA',
//         description: 'Descrição detalhada para Invalidez Permanente e Total por Acidente - IPTA.',
//         image: '/images/aparelho.png',
//         carrency: 'Com carência',
//     },
//     {
//         id: 5,
//         title: 'Diária de Internação Hospitalar por Acidente',
//         description: 'Descrição detalhada para Diária de Internação Hospitalar por Acidente.',
...
//         description: 'Descrição detalhada para Despesas Médicas Hospitalares e Odontológicas.',
...
//         description: 'Descrição detalhada para Auxílio Funeral.',
//         image: '/images/doc.png',
//         carrency: 'Com carência',
//     },
//     {
//         id: 8,
//         title: 'Sorteios - 4 sorteios mensais, série aberta, valor líquido',
//         description: 'Descrição detalhada para Sorteios.',
...
//     return (
//         <div className='w-full px-4 py-8 md:px-10 md:py-10'>
...
//                         <button onClick={handlePrev} className='p-2 bg-gray-800 text-white rounded-full'>
//                             &lt;
//                         </button>
//                         <button className='mx-4 text-xl'>{services[currentIndex].title}</button>
//                         <button onClick={handleNext} className='p-2 bg-gray-800 text-white rounded-full'>
//                             &gt;
//                         </button>
//                     </div>
//                     <ol className='hidden md:flex flex-col text-sm'>
//                         {services.map((service, index) => (
//                             <li
//                                 key={service.id}
//                                 onClick={() => handleSelection(service)}
//                                 className={`cursor-pointer hover:bg-gray-200 p-2 rounded ${index === currentIndex ? 'bg-gray-200' : ''}`}
//                             >
//                                 {service.title}
//                             </li>
//                         ))}
...
//                         <img src={selectedService.image} alt={selectedService.title} className='w-full h-auto object-cover rounded' />
//                     </div>
