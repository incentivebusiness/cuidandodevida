    ...
    <>
      ...
      <div className='pt-[60px] md:pt-0'>
        <div className="w-full pt-[0px] h-screen bg-cover bg-right bg-[url('/images/mobile.png')] 
          ...
          <Header />
          <div className="flex flex-col items-center justify-center  xl:pt-[1rem] h-full px-8">
            <div className='container mx-auto h-full z-10'>
              <motion.div
                className="container mx-auto h-full flex items-start justify-center pt-[6rem]"
              ...
              >
                <div className="text-left text-white px-8">
                  <Image
                    ...
                    width={160}
                    height={100}
                    className='h-auto w-[130px]  md:w-[150px] xl:w-[180px]'
                  />
                  <h2 className='text-5xl md:text-4xl lg:text-4xl xl:text-5xl font-extrabold pb-4 md:pb-6'>
                    Cuidando de Vida
                  </h2>
                  <p className="text-xl sm:text-lg md:text-xl lg:text-2xl xl:text-3xl xl:pb-9 sm:pb-6 md:pb-8">
