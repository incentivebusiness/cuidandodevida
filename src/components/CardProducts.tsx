...
>
  ...
  <div className="mt-4 py-2">
    <div className={`grid grid-cols-2 gap-1 font-semibold ${isHighlighted ? 'text-white' : 'text-[rgb(1,24,74)]'}`}>
      <div><h5 className='text-lg'>Serviços</h5></div>
      <div className="text-center">Preço Máximo de Seguro</div>
    </div>
    {descriptions.map((desc, index) => (
      <div
        key={index}
        className={`grid grid-cols-2 gap-0 items-center border-t pt-2 ${isHighlighted ? 'text-white' : 'text-[rgb(1,24,74)]'}`}
      >
        <div className="flex items-center">
          {desc.icon && (
            <img src={desc.icon} alt={desc.text} className="mr-2" style={{ color: desc.iconColor }} />
          )}
          <p className='text-sm md:text-md pt-2 justify-center items-center'>{desc.text}</p>
        </div>
        <div className="text-center text-[10px]">{desc.maxInsurancePrice || 'N/A'}</div>
        
        {/* Adicionando a informação de "Carência" abaixo de cada item */}
        <div className="col-span-2 text-right text-[9px] font-bold pt-2">
    ...
    //             <img src={desc.icon} alt={desc.text} className="mr-2" style={{ color: desc.iconColor }} />
    //           )}
    //           <p className='text-md pb-2'>{desc.text}</p>
    //         </div>
    //         <div className="text-center text-[10px] pl-10">{desc.maxInsurancePrice || 'N/A'}</div>
...
const MockData: CardProductsProps[] = [
  {
    ...
    descriptions: [
      ...
      { text: 'Decessos', icon: '/images/check.png', maxInsurancePrice: '(familiar, Titular, Cônjuge ou Filhos - R$5.000,00)', hasWaitingPeriod: 'carência 30 dias' },
      { text: '4 Sorteios mensais, série aberta, valor líquido', icon: '/images/check.png', hasWaitingPeriod: false, maxInsurancePrice: 'R$5.000,00' },
      { text: 'Assistência Domiciliar Completa', icon: '/images/cancel.png', maxInsurancePrice: "Não há", hasWaitingPeriod: 'carência 72hrs' },
      { text: 'Programa - MAPFRE Cuidando de Você', icon: '/images/check.png', maxInsurancePrice: 'Rede TEM + Descontos em Farmácias + Telemedicina Familiar(com pagamento de consulta)', hasWaitingPeriod: 'carência 72hrs' },
      { text: 'Assistência Affinity PET', icon: '/images/cancel.png', maxInsurancePrice: "Não há", hasWaitingPeriod: 'carência 72hrs' },
    ],
  ...
  },
  {
    ...
    descriptions: [
      ...
      { text: 'Decessos', icon: '/images/check.png', maxInsurancePrice: '(familiar, Titular, Cônjuge ou Filhos - R$5.000,00)', hasWaitingPeriod: 'carência 30 dias' },
      { text: '4 Sorteios mensais, série aberta, valor líquido', icon: '/images/check.png', maxInsurancePrice: 'R$5.000,00', hasWaitingPeriod: false },
      { text: 'Assistência Domiciliar Completa', icon: '/images/check.png', hasWaitingPeriod: 'carência 72hrs' },
      { text: 'Programa - MAPFRE Cuidando de Você', icon: '/images/check.png', maxInsurancePrice: 'Rede TEM + Descontos em Farmácias + Telemedicina Familiar(com pagamento de consulta)', hasWaitingPeriod: 'carência 72hrs' },
      { text: 'Assistência Affinity PET', icon: '/images/cancel.png', hasWaitingPeriod: 'carência 72hrs' },
    ],
  ...
  },
  {
    ...
    descriptions: [
      ...
      { text: 'Decessos', icon: '/images/checkwh.png', maxInsurancePrice: '(familiar, Titular, Cônjuge ou Filhos - R$5.000,00)', hasWaitingPeriod: 'carência 30 dias' },
      { text: '4 Sorteios mensais, série aberta, valor líquido', icon: '/images/checkwh.png', maxInsurancePrice: 'R$5.000,00', hasWaitingPeriod: false },
      { text: 'Assistência Domiciliar Completa', icon: '/images/checkwh.png', hasWaitingPeriod: 'carência 72hrs' },
      { text: 'Programa - MAPFRE Cuidando de Você', icon: '/images/checkwh.png', maxInsurancePrice: 'Rede TEM + Descontos em Farmácias + Telemedicina Familiar(com pagamento de consulta)', hasWaitingPeriod: 'carência 72hrs' },
      { text: 'Assistência Affinity PET', icon: '/images/checkwh.png', hasWaitingPeriod: 'carência 72hrs' },
    ],
    signLink:'',
